#define newyork2tokyo_cxx
#include "newyork2tokyo.h"
#include <TH2.h>
#include <TGraph.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//      NCherenkov_electron_uvA_Array[ jentry ] = nElectronPositron * calculaN(momentum,m_e,400E-9,315E-9);
   ...
   double totaluva = totalNCherenkov_electron_uvA + totalNCherenkov_positron_uvA + totalNCherenkov_muminus_uvA + totalNCherenkov_muplus_uvA + totalNCherenkov_p_uvA +  totalNCherenkov_pbar_uvA;
   double totaluvb = totalNCherenkov_electron_uvB + totalNCherenkov_positron_uvB + totalNCherenkov_muminus_uvB + totalNCherenkov_muplus_uvB + totalNCherenkov_p_uvB +  totalNCherenkov_pbar_uvB;
   double totaluvc = totalNCherenkov_electron_uvC + totalNCherenkov_positron_uvC + totalNCherenkov_muminus_uvC + totalNCherenkov_muplus_uvC + totalNCherenkov_p_uvC +  totalNCherenkov_pbar_uvC;
   ...
   //
   double E_uva = calculaE(totaluva, 357.5);
   double E_uvb = calculaE(totaluvb, 297.5);
   double E_uvc = calculaE(totaluvc,190);
  ...
  c1->cd();
  c1->SetSelected(c1);
  c1->SaveAs("newyork2tokyo_electronUV.png");
  c1->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c2->cd();
  c2->SetSelected(c2);
  c2->SaveAs("newyork2tokyo_positronUV.png");
  c2->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c3->cd();
  c3->SetSelected(c3);
  c3->SaveAs("newyork2tokyo_muminusUV.png");
  c3->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c4->cd();
  c4->SetSelected(c4);
  c4->SaveAs("newyork2tokyo_muplusUV.png");
  c4->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c5->cd();
  c5->SetSelected(c5);
  c5->SaveAs("newyork2tokyo_pUV.png");
  c5->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c6->cd();
  c6->SetSelected(c6);
  c6->SaveAs("newyork2tokyo_pbarUV.png");
  c6->Close();
...
Double_t calculaE( Double_t Ngamma, Double_t lambdaprom ){
  double nwater = 1.33;
  double hbarc = 0.0001973269718; // MeV nm
