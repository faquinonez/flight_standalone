...
#ifndef saopaulo2johannesburgo_h
#define saopaulo2johannesburgo_h
...
public :
   ...
   saopaulo2johannesburgo(TTree *tree=0);
   virtual ~saopaulo2johannesburgo();
...
#ifdef saopaulo2johannesburgo_cxx
saopaulo2johannesburgo::saopaulo2johannesburgo(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("totalSAOPAULO2JOHANNESBURGO.root/T");
      tree = chain;
#endif // SINGLE_TREE
...
saopaulo2johannesburgo::~saopaulo2johannesburgo()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t saopaulo2johannesburgo::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t saopaulo2johannesburgo::LoadTree(Long64_t entry)
{
...
void saopaulo2johannesburgo::Init(TTree *tree)
{
...
Bool_t saopaulo2johannesburgo::Notify()
{
...
void saopaulo2johannesburgo::Show(Long64_t entry)
{
...
Int_t saopaulo2johannesburgo::Cut(Long64_t entry)
{
...
#endif // #ifdef saopaulo2johannesburgo_cxx
