...
#ifndef bogota2baires_h
#define bogota2baires_h
...
public :
   ...
   bogota2baires(TTree *tree=0);
   virtual ~bogota2baires();
...
#ifdef bogota2baires_cxx
bogota2baires::bogota2baires(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("totalBOGOTA2BAIRES.root/T");
      tree = chain;
#endif // SINGLE_TREE
...
bogota2baires::~bogota2baires()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bogota2baires::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bogota2baires::LoadTree(Long64_t entry)
{
...
void bogota2baires::Init(TTree *tree)
{
...
void bogota2baires::Show(Long64_t entry)
{
...
Int_t bogota2baires::Cut(Long64_t entry)
{
