#define bogota2baires_cxx
#include "bogota2baires.h"
#include <TH2.h>
#include <TGraph.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//      NCherenkov_electron_uvA_Array[ jentry ] = nElectronPositron * calculaN(momentum,m_e,400E-9,315E-9);
  ...
  c1->cd();
  c1->SetSelected(c1);
  c1->SaveAs("bogota2baires_electronUV.png");
  c1->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c2->cd();
  c2->SetSelected(c2);
  c2->SaveAs("bogota2baires_positronUV.png");
  c2->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c3->cd();
  c3->SetSelected(c3);
  c3->SaveAs("bogota2baires_muminusUV.png");
  c3->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c4->cd();
  c4->SetSelected(c4);
  c4->SaveAs("bogota2baires_muplusUV.png");
  c4->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c5->cd();
  c5->SetSelected(c5);
  c5->SaveAs("bogota2baires_pUV.png");
  c5->Close();
  //------------------------------------------------------------------------------------------------
  ...
  c6->cd();
  c6->SetSelected(c6);
  c6->SaveAs("bogota2baires_pbarUV.png");
  c6->Close();
