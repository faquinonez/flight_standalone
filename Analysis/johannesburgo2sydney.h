...
#ifndef johannesburgo2sydney_h
#define johannesburgo2sydney_h
...
public :
   ...
   johannesburgo2sydney(TTree *tree=0);
   virtual ~johannesburgo2sydney();
...
#ifdef johannesburgo2sydney_cxx
johannesburgo2sydney::johannesburgo2sydney(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("totalJOHANNESBURGO2SYDNEY.root/T");
      tree = chain;
#endif // SINGLE_TREE
...
johannesburgo2sydney::~johannesburgo2sydney()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t johannesburgo2sydney::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t johannesburgo2sydney::LoadTree(Long64_t entry)
{
...
void johannesburgo2sydney::Init(TTree *tree)
{
...
Bool_t johannesburgo2sydney::Notify()
{
...
void johannesburgo2sydney::Show(Long64_t entry)
{
...
Int_t johannesburgo2sydney::Cut(Long64_t entry)
{
...
#endif // #ifdef johannesburgo2sydney_cxx
