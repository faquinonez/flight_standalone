...
#ifndef baires2madrid_h
#define baires2madrid_h
...
public :
  ...
  baires2madrid(TTree *tree=0);
   virtual ~baires2madrid();
...
#ifdef baires2madrid_cxx
baires2madrid::baires2madrid(TTree *tree) : fChain(0) 
{
...
baires2madrid::~baires2madrid()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t baires2madrid::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t baires2madrid::LoadTree(Long64_t entry)
{
...
void baires2madrid::Init(TTree *tree)
{
...
void baires2madrid::Show(Long64_t entry)
{
...
Int_t baires2madrid::Cut(Long64_t entry)
{
